...
pressure = np.array([  1000.0000,   1599.8684,   5332.8947,   9865.8553, 
                         11920.0, 12946., 13500., 13972.1842, 15492.0592, 16705.2928,  
...
plt.plot(1e-3*pressure[:points], Nads/8,'-o', color=colors[3], 
         lw=1.75, ms=8, mec='k')
...
plt.plot(1e-3*pressure[:points], Lz/2,'-o', color=colors[3], 
         lw=1.75, ms=8, mec='k')
plt.xlabel('Pressure (kPa)', fontsize=18)
