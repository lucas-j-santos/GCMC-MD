...
plt.plot(1e-3*pressure[:points], 1e1*Lz[:points]/2,'-o', color=colors[2], markersize=9, label='GCMC/MD')
plt.xlabel('Pressure (kPa)', fontsize=18)
...
adsorption_stress = pressure[:points]+strain[:points]/compressibility[:points]

plt.plot(1e-3*pressure[:points], 1e-6*adsorption_stress[:points],'-o', color=colors[2], markersize=9, label='GCMC/MD')
plt.xlabel('Pressure (kPa)', fontsize=18)
...
df['Unit cell (nm)'] = Lz[:points]
df['Strain (%)'] = 1e2*strain[:points]
df['Compressibility (GPa)'] = compressibility[:points]*1e9 
df['Adsorption stress (GPa)'] = adsorption_stress[:points]*1e-9 
